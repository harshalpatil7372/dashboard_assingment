...
//           type: "bot" as const,
//           text: "I'm analyzing your data. Here's what I found based on your query...",
//           details: ["Analysis in progress", "Please wait for detailed insights"],
//           hasChart: false
//         };
...
//   return (
//     <div className="max-w-sm mx-auto bg-gradient-to-br from-blue-600 via-purple-600 to-blue-700 rounded-3xl shadow-2xl overflow-hidden">
//       {/* Header */}
...
//                   <div className="font-medium text-xs text-gray-600 mb-2">Commentary</div>
...
//                     <svg width="120" height="60" viewBox="0 0 120 60" className="w-full h-full">
//                       <path 
...
//               className="flex-shrink-0 bg-white bg-opacity-20 text-white text-xs px-3 py-2 rounded-full border border-white border-opacity-30 hover:bg-opacity-30 transition-all"
//             >
//               {suggestion}
//             </button>
//           ))}
...
//             className="flex-1 px-4 py-2 rounded-full border-none outline-none text-sm placeholder-gray-500"
//           />
//           <button
//             onClick={handleSend}
//             disabled={!query.trim()}
